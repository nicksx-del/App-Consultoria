...
import type { AuthRole, SignupPayload } from '../types/auth';
...
function RoleChip({ role }: { role: AuthRole }) {
  ...
  const roleIcon = role === 'trainer' ? 'account-plus-outline' : 'account-outline';
...
function TermsRow({
  ...
  return (
    <View style={styles.termsRow}>
      <Pressable onPress={onToggle} style={styles.termsTouch}>
        <View style={[styles.checkbox, accepted && styles.checkboxActive]}>
          {accepted ? <Feather name="check" size={12} color="#07110B" /> : null}
        </View>
              ...
              <View style={styles.cardInner}>
                ...
                <View style={styles.heroBlock}>
                  ...
                  <Text style={styles.subtitle}>
                    Preencha seus dados para começar como treinador.
                  </Text>
                </View>
