import { calculateMealTotals } from './nutrition';
...
const MEAL_LOG_SELECT =
  'id, student_id, trainer_id, consultancy_id, nutrition_plan_id, meal_id, meal_name, log_date, weekday, status, totals, notes, created_at, updated_at';
    ...
    .upsert(
      {
        ...
        totals: mealLogPayloadTotals(payload.meal),
